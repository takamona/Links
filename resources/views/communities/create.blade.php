...
<body>
  ...
  <div class="condition_radio">
    <input type="radio" name="participation"value="誰でも参加可能">誰でも参加可能
          <input type="radio" name="participation" value="管理人の承認が必要">管理人の承認が必要
  </div>
  </div>
  <div class="flex">
  <div class="Authority">トピック作成権限</div>
  <div class="Authority_radio">
     <input type="radio" name="authority" value="参加者が作成できる">参加者が作成できる
          <input type="radio" name="authority" value="管理人が作成できる">管理人が作成できる
  </div>
  </div>
  <div class="flex">
  ...
  <div class="Confirmation">
    <button type="submit" value="送信" style="background-color:grey;font-size:15px;width:280px;height:80px;" >
    </div>
    </form>
